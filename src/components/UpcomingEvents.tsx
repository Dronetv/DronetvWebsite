...
const UpcomingEvents = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden min-h-screen">
      {/* Background Elements */}
            ...
            return (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  {/* Category Badge */}
                  <div className={`absolute top-4 left-4 bg-gradient-to-r ${getCategoryColor(event.category)} text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 border border-yellow-400/30`}>
                    {event.category}
                  </div>

                  {/* Price Badge */}
                  <div className={`absolute top-4 right-4 ${getPriceColor(event.price)} text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg transform translate-x-full group-hover:translate-x-0 transition-transform duration-500`}>
                    {event.price}
                  </div>

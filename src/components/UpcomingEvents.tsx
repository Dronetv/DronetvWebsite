            ...
            return (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  {/* Category Badge */}
                  {/* <div className={`absolute top-4 left-4 bg-yellow-400 text-black px-4 py-2 rounded-full text-sm font-bold shadow-lg transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 border border-yellow-400/30`}>
                    {event.category}
                  </div> */}

...
const GalleryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-yellow-400 pt-16">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative w-full lg:w-auto">
              <select
                ...
                className="w-full lg:w-auto appearance-none bg-white/80 backdrop-blur-sm border-2 border-black/20 rounded-xl px-4 py-3 pr-10 text-black font-medium focus:outline-none focus:ring-2 focus:ring-black/20 focus:border-black/40 transition-all duration-300"
              >
      ...
      {/* Photo Grid Section */}
      <section className="py-8 sm:py-12 bg-yellow-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

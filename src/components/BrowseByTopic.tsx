            ...
            return (
              ...
              >
                ...
                <div className="relative p-4 sm:p-6 lg:p-8 h-[500px] sm:h-[550px] lg:h-[600px] flex flex-col">
                  ...
                  {/* Topic Name */}
                  <h3 className="text-xl sm:text-2xl font-black text-white mb-3 sm:mb-4 group-hover:scale-105 transition-all duration-500 drop-shadow-lg group-hover:text-yellow-100">
                    {topic.name}
                  </h3>
                  
                  {/* Description */}
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-3 sm:mb-4 group-hover:text-gray-200 transition-colors duration-300">
                    {topic.description}
                  </p>
                  ...
                  <div className="mb-3 sm:mb-4 flex-grow">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {topic.subcategories.map((sub, idx) => (
                        <div 
                          key={sub}
                          className="bg-yellow-400/10 backdrop-blur-sm rounded-lg px-2 sm:px-3 py-1 sm:py-2 text-gray-300 text-xs font-medium border border-yellow-400/20 group-hover:bg-yellow-400/20 group-hover:border-yellow-400/40 group-hover:text-white transition-all duration-300"
                  ...
                  <div className="flex justify-center mt-auto">
                    <div className="bg-yellow-400/20 backdrop-blur-sm rounded-full px-4 sm:px-6 py-2 sm:py-3 border border-yellow-400/30 group-hover:bg-yellow-400/30 group-hover:scale-105 group-hover:border-yellow-400/50 group-hover:shadow-lg group-hover:shadow-yellow-400/30 transition-all duration-500 flex items-center gap-2">
                      <Play className="h-3 w-3 sm:h-4 sm:w-4 text-yellow-400" />
                      <span className="text-yellow-400 font-semibold text-sm sm:text-base">Explore Content</span>

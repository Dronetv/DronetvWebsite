...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-yellow-400 via-yellow-300 to-yellow-500 min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative max-w-6xl mx-auto text-center z-10 w-full">
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-black mb-6 sm:mb-8 leading-tight tracking-tight">
            <span className="inline-block animate-fade-in-up relative" style={{ animationDelay: '0.2s' }}>
            ...
            <span className="inline-block animate-fade-in-up relative" style={{ animationDelay: '0.6s' }}>
            ...
            <br />
            <span className="inline-block animate-fade-in-up relative" style={{ animationDelay: '0.8s' }}>
            ...
            <span className="inline-block animate-fade-in-up relative" style={{ animationDelay: '1s' }}>
            ...
            <span className="inline-block animate-fade-in-up relative" style={{ animationDelay: '1.2s' }}>

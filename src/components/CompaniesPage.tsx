      ...
      <section className="py-16 bg-gradient-to-br from-yellow-400 via-yellow-300 to-yellow-500 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-black/80 max-w-2xl mx-auto mb-8">
            Discover industry-leading companies shaping the future of drone technology, AI, and geospatial solutions
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-black/80">
              Industry leaders and innovative companies at the forefront of technology
            </p>
          </div>
